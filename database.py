...
#     conn = sqlite3.connect("instance/people_count.db")

#     cur = conn.cursor()

#     cur.execute("""
#         INSERT INTO people_count
#         (source, total_count, zone_a, zone_b, zone_c)
#         VALUES (?, ?, ?, ?, ?)
#     """, ("Webcam", total, zone_a, zone_b, zone_c))
...
#     conn.commit()
#     conn.close()
#     print(f"💾 Data saved: total={total}, zone_a={zone_a}, zone_b={zone_b}, zone_c={zone_c}, zone_d={zone_d}")
